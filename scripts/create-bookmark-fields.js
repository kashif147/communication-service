...
const bookmarkFields = [
  ...
  { key: "remindersType", label: "Reminders Type", path: "subscription.reminderHistory.type", dataType: "string" },
  { key: "remindersReminderDate", label: "Reminders Reminder Date", path: "subscription.reminderHistory.reminderDate", dataType: "date" },
